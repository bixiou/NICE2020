...
\begin{tabular}{lcccc}
  ...
  \midrule
  United States & 0 & -- & 75 & 2.462 \\
  Russia & 0 & -- & 75 & 1.606 \\
  European Union & 75 & 0.312 & 75 & 0.276 \\
  Turkey & 0 & -- & 50 & 1.608 \\
  Indonesia & 50 & 0.957 & 50 & 1.132 \\
  China & 50 & 0.972 & 50 & 0.944 \\
  Brazil & 50 & 0.445 & 50 & 0.527 \\
  India & 25 & 1.254 & 30 & 1.175 \\
  Nigeria & 0 & -- & 30 & 0.255 \\
  DR Congo & 0 & -- & 10 & 0.072 \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 1 --- unscaled rights $\rho_i$ (the allocation sets the cap)}} \\
  \quad Emissions change in the coalition (\%) &  & $-$4.9\% &  & $-$4.3\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.010 &  & $-$0.017 \\
  \quad World welfare gain, EDE (\%) &  & 0.041\% &  & 0.111\% \\
  \quad World mean consumption gain (\%) &  & 0.028\% &  & 0.044\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 2 --- surplus allocated to minimise the largest shortfall}} \\
  \quad World welfare gain, EDE (\%) &  & 0.015\% &  & 0.104\% \\
  \quad World mean consumption gain (\%) &  & 0.020\% &  & 0.057\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 3 --- surplus shared by marginal utility}} \\
  \quad World welfare gain, EDE (\%) &  & 0.039\% &  & 0.259\% \\
  \quad World mean consumption gain (\%) &  & 0.021\% &  & 0.059\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 4 --- surplus shared by uniform scaling}} \\
  \quad World welfare gain, EDE (\%) &  & 0.008\% &  & 0.079\% \\
