...
\begin{tabular}{lcccc}
  ...
  \midrule
  United States & 0 & -- & 75 & 2.575 \\
  Russia & 0 & -- & 75 & 1.626 \\
  European Union & 75 & 0.309 & 75 & 0.271 \\
  Turkey & 0 & -- & 50 & 1.605 \\
  Indonesia & 50 & 0.964 & 50 & 1.124 \\
  China & 50 & 0.951 & 50 & 0.921 \\
  Brazil & 50 & 0.454 & 50 & 0.528 \\
  India & 25 & 1.232 & 30 & 1.16 \\
  Nigeria & 0 & -- & 30 & 0.237 \\
  DR Congo & 0 & -- & 10 & 0.057 \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 1 --- unscaled rights $\rho_i$ (the allocation sets the cap)}} \\
  \quad Emissions change in the coalition (\%) &  & $-$6.1\% &  & $-$5.2\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.012 &  & $-$0.021 \\
  \quad World welfare gain, EDE (\%) &  & 0.050\% &  & 0.109\% \\
  ...
  \quad World welfare gain, EDE (\%) &  & 0.044\% &  & 0.256\% \\
  \quad World mean consumption gain (\%) &  & 0.021\% &  & 0.061\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 4 --- surplus shared by uniform scaling}} \\
  \quad World welfare gain, EDE (\%) &  & 0.010\% &  & 0.068\% \\
  \quad World mean consumption gain (\%) &  & 0.019\% &  & 0.055\% \\
  \bottomrule
\end{tabular}
