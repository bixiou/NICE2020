...
\begin{tabular}{lcccc}
  ...
  Russia & 0 & -- & 75 & 1.895 \\
  European Union & 75 & 0.358 & 75 & 0.365 \\
  Turkey & 0 & -- & 50 & 1.625 \\
  ...
  \quad Emissions change in the coalition (\%) &  & $-$9.5\% &  & $-$8.5\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.019 &  & $-$0.034 \\
  \quad World welfare gain, EDE (\%) &  & 0.052\% &  & 0.068\% \\
  \quad World mean consumption gain (\%) &  & 0.030\% &  & 0.036\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 2 --- surplus allocated to minimise the largest shortfall}} \\
  \quad World welfare gain, EDE (\%) &  & 0.018\% &  & 0.096\% \\
  ...
  \quad World mean consumption gain (\%) &  & 0.020\% &  & 0.059\% \\
  \midrule
