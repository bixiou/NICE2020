...
\centering
\small
\caption{Club-price rights ratios $\rho_i$ equivalent to the Wolfram et al. and Banerjee et al. proposals --- option A (per-country solve)}
...
\begin{tabular}{lcccc}
  ...
  \midrule
  United States & 0 & -- & 75 & 2.158 \\
  Russia & 0 & -- & 75 & 1.358 \\
  European Union & 75 & 0.255 & 75 & 0.262 \\
  Turkey & 0 & -- & 50 & 1.538 \\
  Indonesia & 50 & 0.889 & 50 & 1.09 \\
  China & 50 & 0.836 & 50 & 0.883 \\
  Brazil & 50 & 0.377 & 50 & 0.499 \\
  India & 25 & 1.299 & 30 & 1.183 \\
  Nigeria & 0 & -- & 30 & 0.245 \\
  DR Congo & 0 & -- & 10 & 0.063 \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 1 --- unscaled rights $\rho_i$ (the allocation sets the cap)}} \\
  \quad Gain in rights (\% of the club's emissions) &  & 9.9\% &  & 9.1\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.020 &  & $-$0.037 \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 2 --- rights rescaled to the club's emissions}} \\
  \quad World welfare gain, EDE (\%) &  & 0.028\% &  & 0.102\% \\
  \quad World mean consumption gain (\%) &  & 0.022\% &  & 0.057\% \\
  \midrule
  ...
  \quad World welfare gain, EDE (\%) &  & 0.081\% &  & 0.419\% \\
  \quad World mean consumption gain (\%) &  & 0.024\% &  & 0.068\% \\
  \bottomrule
\end{tabular}
