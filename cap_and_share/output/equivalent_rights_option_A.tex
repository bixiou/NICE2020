...
\begin{tabular}{lcccc}
  ...
  \midrule
  United States & 0 & -- & 75 & 2.816 \\
  Russia & 0 & -- & 75 & 1.742 \\
  European Union & 75 & 0.281 & 75 & 0.275 \\
  Turkey & 0 & -- & 50 & 1.525 \\
  Indonesia & 50 & 0.992 & 50 & 1.086 \\
  China & 50 & 0.892 & 50 & 0.882 \\
  Brazil & 50 & 0.454 & 50 & 0.484 \\
  India & 25 & 1.271 & 30 & 1.144 \\
  Nigeria & 0 & -- & 30 & 0.217 \\
  DR Congo & 0 & -- & 10 & 0.052 \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 1 --- unscaled rights $\rho_i$ (the allocation sets the cap)}} \\
  \quad Emissions change in the coalition (\%) &  & $-$6.9\% &  & $-$6.7\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.014 &  & $-$0.027 \\
  \quad World welfare gain, EDE (\%) &  & 0.062\% &  & 0.113\% \\
  \quad World mean consumption gain (\%) &  & 0.031\% &  & 0.042\% \\
  \midrule
  ...
  \quad World welfare gain, EDE (\%) &  & 0.053\% &  & 0.292\% \\
  \quad World mean consumption gain (\%) &  & 0.022\% &  & 0.061\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 4 --- surplus shared by uniform scaling}} \\
  \quad World welfare gain, EDE (\%) &  & 0.016\% &  & 0.050\% \\
  \quad World mean consumption gain (\%) &  & 0.020\% &  & 0.052\% \\
  \bottomrule
\end{tabular}
