...
\begin{tabular}{lcccc}
  ...
  \midrule
  United States & 0 & -- & 75 & 2.758 \\
  Russia & 0 & -- & 75 & 1.767 \\
  European Union & 75 & 0.294 & 75 & 0.286 \\
  Turkey & 0 & -- & 50 & 1.533 \\
  Indonesia & 50 & 0.997 & 50 & 1.094 \\
  China & 50 & 0.932 & 50 & 0.916 \\
  Brazil & 50 & 0.46 & 50 & 0.487 \\
  India & 25 & 1.277 & 30 & 1.15 \\
  Nigeria & 0 & -- & 30 & 0.235 \\
  DR Congo & 0 & -- & 10 & 0.065 \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 1 --- unscaled rights $\rho_i$ (the allocation sets the cap)}} \\
  \quad Emissions change in the coalition (\%) &  & $-$5.3\% &  & $-$5.5\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.010 &  & $-$0.022 \\
  \quad World welfare gain, EDE (\%) &  & 0.046\% &  & 0.100\% \\
  \quad World mean consumption gain (\%) &  & 0.029\% &  & 0.043\% \\
  \midrule
  ...
  \quad World welfare gain, EDE (\%) &  & 0.043\% &  & 0.263\% \\
