...
\begin{tabular}{lcccc}
  ...
  \midrule
  United States & 0 & -- & 75 & 2.988 \\
  Russia & 0 & -- & 75 & 1.898 \\
  European Union & 75 & 0.449 & 75 & 0.395 \\
  Turkey & 0 & -- & 50 & 1.503 \\
  Indonesia & 50 & 0.963 & 50 & 1.055 \\
  China & 50 & 1.064 & 50 & 1.002 \\
  Brazil & 50 & 0.462 & 50 & 0.482 \\
  India & 25 & 1.123 & 30 & 1.059 \\
  Nigeria & 0 & -- & 30 & 0.220 \\
  DR Congo & 0 & -- & 10 & 0.057 \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 1 --- unscaled rights $\rho_i$ (the allocation sets the cap)}} \\
  \quad Emissions change in the coalition (\%) &  & $-$4.8\% &  & $-$4.8\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.010 &  & $-$0.019 \\
  \quad World welfare gain, EDE (\%) &  & 0.027\% &  & 0.072\% \\
  \quad World mean consumption gain (\%) &  & 0.023\% &  & 0.037\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 2 --- surplus allocated to minimise the largest shortfall}} \\
  \quad World welfare gain, EDE (\%) &  & 0.005\% &  & 0.053\% \\
  \quad World mean consumption gain (\%) &  & 0.019\% &  & 0.050\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 3 --- surplus shared by marginal utility}} \\
  \quad World welfare gain, EDE (\%) &  & 0.037\% &  & 0.232\% \\
  \quad World mean consumption gain (\%) &  & 0.020\% &  & 0.054\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 4 --- surplus shared by uniform scaling}} \\
  \quad World welfare gain, EDE (\%) &  & $-$0.000\% &  & 0.040\% \\
  \quad World mean consumption gain (\%) &  & 0.018\% &  & 0.049\% \\
  \bottomrule
\end{tabular}
