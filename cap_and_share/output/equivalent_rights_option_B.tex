...
\begin{tabular}{lcccc}
  ...
  \midrule
  \multicolumn{5}{l}{\textit{Variant 2 --- rights rescaled to the club's emissions}} \\
  \quad World welfare gain, EDE (\%) &  & $-$0.006\% &  & $-$0.009\% \\
  \quad World mean consumption gain (\%) &  & 0.018\% &  & 0.048\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 3 --- floored on option A's allocation, then rescaled}} \\
  \quad World welfare gain, EDE (\%) &  & 0.011\% &  & 0.041\% \\
  \quad World mean consumption gain (\%) &  & 0.020\% &  & 0.047\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 4 --- surplus shared by marginal utility}} \\
