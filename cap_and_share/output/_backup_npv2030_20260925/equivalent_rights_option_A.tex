...
\begin{tabular}{lcccc}
  ...
  \midrule
  United States & 0 & -- & 75 & 2.784 \\
  Russia & 0 & -- & 75 & 1.783 \\
  European Union & 75 & 0.294 & 75 & 0.288 \\
  Turkey & 0 & -- & 50 & 1.545 \\
  Indonesia & 50 & 0.997 & 50 & 1.102 \\
  China & 50 & 0.932 & 50 & 0.921 \\
  Brazil & 50 & 0.46 & 50 & 0.489 \\
  India & 25 & 1.277 & 30 & 1.157 \\
  Nigeria & 0 & -- & 30 & 0.235 \\
  DR Congo & 0 & -- & 10 & 0.064 \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 1 --- unscaled rights $\rho_i$ (the allocation sets the cap)}} \\
  \quad Emissions change in the coalition (\%) &  & $-$5.3\% &  & $-$4.9\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.010 &  & $-$0.020 \\
  \quad World welfare gain, EDE (\%) &  & 0.046\% &  & 0.089\% \\
  \quad World mean consumption gain (\%) &  & 0.029\% &  & 0.042\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 2 --- surplus allocated to minimise the largest shortfall}} \\
  \quad World welfare gain, EDE (\%) &  & 0.010\% &  & 0.051\% \\
  \quad World mean consumption gain (\%) &  & 0.020\% &  & 0.053\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 3 --- surplus shared by marginal utility}} \\
  \quad World welfare gain, EDE (\%) &  & 0.043\% &  & 0.246\% \\
  \quad World mean consumption gain (\%) &  & 0.022\% &  & 0.058\% \\
  \midrule
