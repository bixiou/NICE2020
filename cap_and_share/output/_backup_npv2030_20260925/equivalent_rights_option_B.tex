...
\begin{tabular}{lcccc}
  ...
  \midrule
  United States & 0 & -- & 75 & 2.917 \\
  Russia & 0 & -- & 75 & 1.88 \\
  European Union & 75 & 0.324 & 75 & 0.286 \\
  Turkey & 0 & -- & 50 & 1.551 \\
  Indonesia & 50 & 1.012 & 50 & 1.103 \\
  China & 50 & 0.976 & 50 & 0.919 \\
  Brazil & 50 & 0.469 & 50 & 0.489 \\
  India & 25 & 1.212 & 30 & 1.126 \\
  Nigeria & 0 & -- & 30 & 0.227 \\
  DR Congo & 0 & -- & 10 & 0.06 \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 1 --- unscaled rights $\rho_i$ (the allocation sets the cap)}} \\
  \quad Emissions change in the coalition (\%) &  & $-$5.1\% &  & $-$4.7\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.010 &  & $-$0.019 \\
  \quad World welfare gain, EDE (\%) &  & 0.035\% &  & 0.074\% \\
  \quad World mean consumption gain (\%) &  & 0.027\% &  & 0.040\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 2 --- surplus allocated to minimise the largest shortfall}} \\
  \quad World welfare gain, EDE (\%) &  & 0.006\% &  & 0.054\% \\
  \quad World mean consumption gain (\%) &  & 0.019\% &  & 0.053\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 3 --- surplus shared by marginal utility}} \\
  \quad World welfare gain, EDE (\%) &  & 0.034\% &  & 0.231\% \\
  \quad World mean consumption gain (\%) &  & 0.021\% &  & 0.057\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 4 --- surplus shared by uniform scaling}} \\
  \quad World welfare gain, EDE (\%) &  & 0.001\% &  & 0.039\% \\
  \quad World mean consumption gain (\%) &  & 0.018\% &  & 0.052\% \\
  \bottomrule
\end{tabular}
