...
\centering
\small
\caption{Club-price rights ratios $\rho_i$ equivalent to the Wolfram et al. and Banerjee, Duflo \& Greenstone proposals --- option A (per-country solve)}
...
\begin{tabular}{lcccc}
  ...
  \midrule
  United States & 0 & -- & 75 & 2.875 \\
  Russia & 0 & -- & 75 & 1.814 \\
  European Union & 75 & 0.417 & 75 & 0.407 \\
  Turkey & 0 & -- & 50 & 1.494 \\
  Indonesia & 50 & 0.952 & 50 & 1.050 \\
  China & 50 & 1.026 & 50 & 1.012 \\
  Brazil & 50 & 0.455 & 50 & 0.482 \\
  India & 25 & 1.181 & 30 & 1.081 \\
  Nigeria & 0 & -- & 30 & 0.226 \\
  DR Congo & 0 & -- & 10 & 0.060 \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 1 --- unscaled rights $\rho_i$ (the allocation sets the cap)}} \\
  \quad Emissions change in the coalition (\%) &  & $-$4.9\% &  & $-$5.0\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.010 &  & $-$0.020 \\
  \quad World welfare gain, EDE (\%) &  & 0.036\% &  & 0.080\% \\
  \quad World mean consumption gain (\%) &  & 0.024\% &  & 0.037\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 2 --- surplus allocated to minimise the largest shortfall}} \\
  \quad World welfare gain, EDE (\%) &  & 0.008\% &  & 0.046\% \\
  \quad World mean consumption gain (\%) &  & 0.019\% &  & 0.050\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 3 --- surplus shared by marginal utility}} \\
  \quad World welfare gain, EDE (\%) &  & 0.045\% &  & 0.243\% \\
  \quad World mean consumption gain (\%) &  & 0.021\% &  & 0.054\% \\
  \midrule
