...
\begin{tabular}{lcccc}
  ...
  \quad Emissions change in the coalition (\%) &  & $-$9.9\% &  & $-$9.1\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.020 &  & $-$0.037 \\
  \quad World welfare gain, EDE (\%) &  & 0.098\% &  & 0.208\% \\
  \quad World mean consumption gain (\%) &  & 0.037\% &  & 0.050\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 2 --- surplus allocated to minimise the largest shortfall}} \\
  \quad World welfare gain, EDE (\%) &  & 0.023\% &  & 0.095\% \\
