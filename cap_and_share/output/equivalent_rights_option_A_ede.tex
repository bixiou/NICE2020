...
\begin{tabular}{lcccc}
  ...
  \midrule
  United States & 0 & -- & 75 & 2.129 \\
  Russia & 0 & -- & 75 & 1.393 \\
  European Union & 75 & 0.266 & 75 & 0.273 \\
  Turkey & 0 & -- & 50 & 1.556 \\
  Indonesia & 50 & 0.892 & 50 & 1.104 \\
  China & 50 & 0.876 & 50 & 0.926 \\
  Brazil & 50 & 0.382 & 50 & 0.501 \\
  India & 25 & 1.306 & 30 & 1.195 \\
  Nigeria & 0 & -- & 30 & 0.261 \\
  DR Congo & 0 & -- & 10 & 0.076 \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 1 --- unscaled rights $\rho_i$ (the allocation sets the cap)}} \\
  \quad Emissions change in the coalition (\%) &  & $-$8.3\% &  & $-$7.3\% \\
  \quad World temperature 2100, change ($^\circ$C) &  & $-$0.016 &  & $-$0.029 \\
  \quad World welfare gain, EDE (\%) &  & 0.082\% &  & 0.182\% \\
  \quad World mean consumption gain (\%) &  & 0.036\% &  & 0.052\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 2 --- surplus allocated to minimise the largest shortfall}} \\
  \quad World welfare gain, EDE (\%) &  & 0.021\% &  & 0.100\% \\
  \quad World mean consumption gain (\%) &  & 0.021\% &  & 0.057\% \\
  \midrule
  \multicolumn{5}{l}{\textit{Variant 3 --- surplus shared by marginal utility}} \\
  \quad World welfare gain, EDE (\%) &  & 0.071\% &  & 0.346\% \\
  \quad World mean consumption gain (\%) &  & 0.024\% &  & 0.062\% \\
  \midrule
